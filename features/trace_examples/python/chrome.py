...
Unlike "trace.py", this file sends the trace reporting data to a file,
which can then be viewed in Google Chrome.
...
REPORT_FILE = os.path.join(_CURRENT_DIRECTORY, "report.json")
...
def main():
    ...
    # reporter.Report()
    reporter.ReportChromeTracingToFile(REPORT_FILE)
